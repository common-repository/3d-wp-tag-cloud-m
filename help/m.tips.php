...
<div class="section_content">
	...
	<p><span>4. </span>Get clue for plugin abilities from these Multiple Cloud <a style="color:#dc143c; font-weight: bold;" href="http://peter.bg/archives/7373" target="_blank">examples</a>.</p>
</div>
<h3>Shape Tips</h3>
<div class="section_content">
	<p><span>1. </span>Most of the shapes have quite complex surface. Therefore small and rounded image tags are preferable because they fit better to the shape. Thus they don't hide it but 
	bold its beauty.</span></p>
	...
	- <span>Möbius**</span>: Read the footnote.<br>
    ...
    ** These shapes have complex surface with sharp vertices and/or hedges. Due to it if you use small number of tags they can't show the beauty of the shape, and if you increase 
	...
	<p><span>3. </span>Don't be surprised that <span>Radius Z</span> option has no effect when a 2D shape has been selected. If the shape is <span>Beam</span> both option <span>Radius Y</span> and <span>Radius Z</span> have no effect.</p>
	<p><span>4. </span>Be aware that some shapes need specific number of tags in order to look completed. These are: <span>3D axes</span>, <span>Christmas fir</span>, <span>Circles</span>, 
...
<div class="section_content">
	...
	<p><span>5. </span>If there is a Portfolio, a Slider or an Accordion in your WP theme or you have added them via plugins, Accordions, Portfolio Categories, Portfolio Items, Portfolio Filters, Slider Categories and/or Slider Items
	can be Cloud Content. For that purpose create a menu in WP through <span>Appearance > Menus</span> panel. Click on <span>Screen Options</span> (top right corner of the page) and 
	tick the Accordion's, Portfolio's or Slider's Custom Taxonomy you want in the cloud. Then create a menu with them, save it and go to your widget instance. Choose <span>Menu</span> for <span>CONTENT</span> of 
	your cloud, select the <span>Menu Name</span> you've just created and save the instance.
	<p><span>6. </span>Be aware that <span>Page/Post Links</span> will load in the cloud ALL links from current Page/Post, which may include navigation links, comments, meta tags etc. To avoid this specify a custom HTML container (div, table, ul etc.) so that only the links in it will be loaded.</p>
	<p><span>7. </span>Be known that <span>Menu</span>, <span>Pages</span> and <span>Page/Post Links</span> CAN NOT be subject to weighting.</p>
</div>
<h3>Coloring Tips</h3>
<div class="section_content">
	...
	<div id="accordion-5" style="padding: 0 0 4px 0;">
		...
		<div class="section_content">
			<p>
				...
				object: <a style="color:#dc143c; font-weight: bold;" href="http://peter.bg/archives/7840" title="Go there and get one!" target="_blank">Samples of Center Function</a>
			</p>
		</div>
		...
		<h3>8. How to ask a question or make a suggestion</h3>
		<div class="section_content">
			<p>
