...
//----- Adding script into page head -----
		jQuery('<script>')
			...
			.text('jQuery(window).on("orientationchange",function(event){ mocasi = window.innerWidth; jQuery("#all_tag_canvas_<?= $inst_id; ?>").attr({"width":mocasi,"height":mocasi}); jQuery("#all_tag_canvas_wrap_<?= $inst_id; ?>").css({"width":mocasi,"height":mocasi});});')
			.appendTo('body');
//----- Changing Canvas sizes for mobile devices -----
			...
			if(c.search('mobile')!=-1){
				...
				jQuery('#all_tag_canvas_<?= $inst_id; ?>').attr({'width':mocasi,'height':mocasi});
				jQuery('#all_menu_canvas_<?= $inst_id; ?>').attr('width',mocasi);
				jQuery('#all_in_one_menu_container_<?= $inst_id; ?>, #all_in_one_menu_container_wrap_<?= $inst_id; ?>, #all_menu_canvas_wrap_<?= $inst_id; ?>').css('width',mocasi);
				jQuery('#all_tag_canvas_wrap_<?= $inst_id; ?>').css({'width':mocasi,'height':mocasi});
			}
			else{
				jQuery('#all_tag_canvas_<?= $inst_id; ?>').attr({'width':'<?= $width; ?>','height':'<?= $height; ?>'});
				jQuery('#all_menu_canvas_<?= $inst_id; ?>').attr('width',<?= $width; ?>);
				jQuery('#all_in_one_menu_container_<?= $inst_id; ?>, #all_in_one_menu_container_wrap_<?= $inst_id; ?>, #all_menu_canvas_wrap_<?= $inst_id; ?>').css('width',<?= $width; ?>);
				jQuery('#all_tag_canvas_wrap_<?= $inst_id; ?>').css({'width':'<?= $width; ?>','height':'<?= $height; ?>'});
			};
...
//----- Preparing variables for various purposes -----
		...
		var cat_numberop = <?= $cat_numberop; ?>;
		var pos_numberot = <?= $pos_numberot; ?>;
...
//----- Weighting Links and Recent Posts according to their order of appearance and Authors according to the number of their publications -----
			if(taxonomy=="links"||taxonomy=="authors"||taxonomy=="recent_posts"){
				...
				var ws;
				switch(taxonomy){
					case "links": ws = <?= $lin_weight_size; ?> ; break;
					case "recent_posts": ws = <?= $rec_weight_size; ?>; break;
				}
...
//----- Variables for Archives cloud -----
				...
				var all_archives_options = {
					...
					clickToFront: c.search('mobile')!=-1?null:<?= $arch_click_to_front; ?>,
					decel: 0.9,
					depth: 0.1,
					...
					minTags: <?= $arch_min_tags; ?>,
					noTagsMessage: true,
					outlineColour: '#<?= $arch_outline_color; ?>',
					outlineDash: <?= $arch_outline_dash; ?>,
					outlineDashSpace: <?= $arch_outline_dash_space; ?>,
					outlineDashSpeed: <?= $arch_outline_dash_speed; ?>,
...
//----- Variables for Authors cloud -----
				...
				var all_authors_options = {
					...
					bgRadius: 5,
					centreFunc: window[all_cf_name],
					clickToFront: c.search('mobile')!=-1?null:<?= $auth_click_to_front; ?>,
					decel: 0.9,
					depth: 0.1,
					...
					minTags: <?= $auth_min_tags; ?>,
					noTagsMessage: true,
					outlineColour: '#<?= $auth_outline_color; ?>',
					outlineDash: <?= $auth_outline_dash; ?>,
					outlineDashSpace: <?= $auth_outline_dash_space; ?>,
					outlineDashSpeed: <?= $auth_outline_dash_speed; ?>,
...
//----- Variables for Categories cloud -----
				...
				var all_categories_options = {
					...
					bgRadius: 5,
					centreFunc: window[all_cf_name],
					clickToFront: c.search('mobile')!=-1?null:<?= $cat_click_to_front; ?>,
					decel: 0.9,
					depth: 0.1,
					...
					minTags: <?= $cat_min_tags; ?>,
					noTagsMessage: true,
					outlineColour: '#<?= $cat_outline_color; ?>',
					outlineDash: <?= $cat_outline_dash; ?>,
					outlineDashSpace: <?= $cat_outline_dash_space; ?>,
					outlineDashSpeed: <?= $cat_outline_dash_speed; ?>,
...
//----- Variables for Links cloud -----
				...
				var all_links_options = {
					...
					bgRadius: 5,
					centreFunc: window[all_cf_name],
					clickToFront: c.search('mobile')!=-1?null:<?= $lin_click_to_front; ?>,
					decel: 0.9,
					depth: 0.1,
					...
					minTags: <?= $lin_min_tags; ?>,
					noTagsMessage: true,
					outlineColour: '#<?= $lin_outline_color; ?>',
					outlineDash: <?= $lin_outline_dash; ?>,
					outlineDashSpace: <?= $lin_outline_dash_space; ?>,
					outlineDashSpeed: <?= $lin_outline_dash_speed; ?>,
...
//----- Variables for Menu cloud -----
				...
				var all_menu_options = {
					...
					bgRadius: 5,
					centreFunc: window[all_cf_name],
					clickToFront: c.search('mobile')!=-1?null:<?= $men_click_to_front; ?>,
					decel: 0.9,
					depth: 0.1,
					...
					minTags: <?= $men_min_tags; ?>,
					noTagsMessage: true,
					outlineColour: '#<?= $men_outline_color; ?>',
					outlineDash: <?= $men_outline_dash; ?>,
					outlineDashSpace: <?= $men_outline_dash_space; ?>,
					outlineDashSpeed: <?= $men_outline_dash_speed; ?>,
...
//----- Variables for Pages cloud -----
				...
				var all_pages_options = {
					...
					bgRadius: 5,
					centreFunc: window[all_cf_name],
					clickToFront: c.search('mobile')!=-1?null:<?= $pag_click_to_front; ?>,
					decel: 0.9,
					depth: 0.1,
					...
					minTags: <?= $pag_min_tags; ?>,
					noTagsMessage: true,
					outlineColour: '#<?= $pag_outline_color; ?>',
					outlineDash: <?= $pag_outline_dash; ?>,
					outlineDashSpace: <?= $pag_outline_dash_space; ?>,
					outlineDashSpeed: <?= $pag_outline_dash_speed; ?>,
...
//----- Variables for Post Tags cloud -----
				...
				var all_post_tags_options = {
					...
					bgRadius: 5,
					centreFunc: window[all_cf_name],
					clickToFront: c.search('mobile')!=-1?null:<?= $pos_click_to_front; ?>,
					decel: 0.9,
					depth: 0.1,
					...
					minTags: <?= $pos_min_tags; ?>,
					noTagsMessage: true,
					outlineColour: '#<?= $pos_outline_color; ?>',
					outlineDash: <?= $pos_outline_dash; ?>,
					outlineDashSpace: <?= $pos_outline_dash_space; ?>,
					outlineDashSpeed: <?= $pos_outline_dash_speed; ?>,
...
//----- Variables for Recent Posts cloud -----
				...
				var all_recent_posts_options = {
					...
					bgRadius: 10,
					centreFunc: window[all_cf_name],
					clickToFront: c.search('mobile')!=-1?null:<?= $rec_click_to_front; ?>,
					decel: 0.9,
					depth: 0.1,
					...
					minTags: <?= $rec_min_tags; ?>,
					noTagsMessage: true,
					outlineColour: '#<?= $rec_outline_color; ?>',
					outlineDash: <?= $rec_outline_dash; ?>,
					outlineDashSpace: <?= $rec_outline_dash_space; ?>,
					outlineDashSpeed: <?= $rec_outline_dash_speed; ?>,
...
//----- Variables for Page/Post Links cloud -----
				...
				var all_ppl_options = {
					...
					bgRadius: 10,
					centreFunc: window[all_cf_name],
					clickToFront: c.search('mobile')!=-1?null:<?= $ppl_click_to_front; ?>,
					decel: 0.9,
					depth: 0.1,
					...
					minTags: <?= $ppl_min_tags; ?>,
					noTagsMessage: true,
					outlineColour: '#<?= $ppl_outline_color; ?>',
					outlineDash: <?= $ppl_outline_dash; ?>,
					outlineDashSpace: <?= $ppl_outline_dash_space; ?>,
					outlineDashSpeed: <?= $ppl_outline_dash_speed; ?>,
...
//----- Variables for All in One Menu Cloud -----
			if(all_menu_type == 'dynamic'){
				...
				var all_in_one_menu_options = {
					...
					outlineThickness: 3,
					padding: padding,
					radiusX: c.search('mobile')!=-1?0.7*<?= $all_m_radius_x; ?>:<?= $all_m_radius_x; ?>,
					radiusY: c.search('mobile')!=-1?0.7*<?= $all_m_radius_x; ?>:<?= $all_m_radius_x; ?>,
					radiusZ: c.search('mobile')!=-1?0.7*<?= $all_m_radius_x; ?>:<?= $all_m_radius_x; ?>,
					shadow: '#<?= $all_m_shadow; ?>',
...
//----- Changing cloud via clicking on All in One Menu items -----
		jQuery('#all_in_one_menu_container_<?= $inst_id; ?> a').click(function(){
			...
			if(all_options=='all_archives_options'){
				if(shor_tax+'_img_url' != ''){jQuery('#all_tag_canvas_<?= $inst_id; ?>').css({'background': 'url("'+arc_img_url+'") no-repeat center', 'background-size': 'cover'}).attr('title','<?= $arch_tooltip; ?>').hide().fadeIn(1000);}; 
				...
				if(shor_tax+'_img_url' != ''){jQuery('#all_tag_canvas_<?= $inst_id; ?>').css({'background': 'url("'+aut_img_url+'") no-repeat center', 'background-size': 'cover'}).attr('title','<?= $auth_tooltip; ?>').hide().fadeIn(1000);}; 
				TagCanvas.Delete('all_tag_canvas_<?=$inst_id; ?>'); 
				TagCanvas.Start('all_tag_canvas_<?=$inst_id; ?>', all_content, all_authors_options);
				}
				else {if(all_options=='all_categories_options'){
					if(shor_tax+'_img_url' != ''){jQuery('#all_tag_canvas_<?= $inst_id; ?>').css({'background': 'url("'+cat_img_url+'") no-repeat center', 'background-size': 'cover'}).attr('title','').hide().fadeIn(1000);}; 
					TagCanvas.Delete('all_tag_canvas_<?=$inst_id; ?>'); 
					TagCanvas.Start('all_tag_canvas_<?=$inst_id; ?>', all_content, all_categories_options);
					}
					else {if(all_options=='all_links_options'){
						if(shor_tax+'_img_url' != ''){jQuery('#all_tag_canvas_<?= $inst_id; ?>').css({'background': 'url("'+lin_img_url+'") no-repeat center', 'background-size': 'cover'}).attr('title','<?= $lin_tooltip; ?>').hide().fadeIn(1000);}; 
						TagCanvas.Delete('all_tag_canvas_<?=$inst_id; ?>'); 
						TagCanvas.Start('all_tag_canvas_<?=$inst_id; ?>', all_content, all_links_options);
						}
						else {if(all_options=='all_menu_options'){
							if(shor_tax+'_img_url' != ''){jQuery('#all_tag_canvas_<?= $inst_id; ?>').css({'background': 'url("'+men_img_url+'") no-repeat center', 'background-size': 'cover'}).attr('title','<?= $men_tooltip; ?>').hide().fadeIn(1000);}; 
							TagCanvas.Delete('all_tag_canvas_<?=$inst_id; ?>'); 
							TagCanvas.Start('all_tag_canvas_<?=$inst_id; ?>', all_content, all_menu_options);
							}
							else {if(all_options=='all_pages_options'){
								if(shor_tax+'_img_url' != ''){jQuery('#all_tag_canvas_<?= $inst_id; ?>').css({'background': 'url("'+pag_img_url+'") no-repeat center', 'background-size': 'cover'}).attr('title','<?= $pag_tooltip; ?>').hide().fadeIn(1000);}; 
								TagCanvas.Delete('all_tag_canvas_<?=$inst_id; ?>'); 
								TagCanvas.Start('all_tag_canvas_<?=$inst_id; ?>', all_content, all_pages_options);
								}
								else {if(all_options=='all_post_tags_options'){
									if(shor_tax+'_img_url' != ''){jQuery('#all_tag_canvas_<?= $inst_id; ?>').css({'background': 'url("'+pos_img_url+'") no-repeat center', 'background-size': 'cover'}).attr('title','').hide().fadeIn(1000);}; 
									TagCanvas.Delete('all_tag_canvas_<?=$inst_id; ?>'); 
									TagCanvas.Start('all_tag_canvas_<?=$inst_id; ?>', all_content, all_post_tags_options)
									}
									else {if(all_options=='all_ppl_options'){
										if(shor_tax+'_img_url' != ''){jQuery('#all_tag_canvas_<?= $inst_id; ?>').css({'background': 'url("'+ppl_img_url+'") no-repeat center', 'background-size': 'cover'}).attr('title','').hide().fadeIn(1000);}; 
										TagCanvas.Delete('all_tag_canvas_<?=$inst_id; ?>'); 
										TagCanvas.Start('all_tag_canvas_<?=$inst_id; ?>', all_content, all_ppl_options)
										}
										else {
											if(shor_tax+'_img_url' != ''){jQuery('#all_tag_canvas_<?= $inst_id; ?>').css({'background': 'url("'+rec_img_url+'") no-repeat center', 'background-size': 'cover'}).attr('title','<?= $rec_tooltip; ?>').hide().fadeIn(1000);}; 
											TagCanvas.Delete('all_tag_canvas_<?=$inst_id; ?>'); 
